...
RSpec.describe "Post index page" , type: :system do
    before do
        ...
        Post.create(Title: 'Hello from Mars', Text: "Lorem Ipsum is simply dummy text of the printing and typesetting industry.", CommentsCounter: 0, LikesCounter: 0, user_id: user.id)
        @post = Post.create(Title: 'Hello from Earth', Text: "The printing and typesetting industry.", CommentsCounter: 0, LikesCounter: 0, user_id: user.id)
